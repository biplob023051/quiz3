                        ...
                        <?php foreach ($subjects as $subject): ?>
                            <tr>
                                ...
                                <td class="text-center" nowrap="nowrap">
                                    ...
                                    <?php if(!$subject->isactive):?>
                                        <?= $this->Form->postLink(__('Delete'), array('action' => 'delete', $subject->id,'?'=>array('redirect_url'=>urlencode(Router::reverse($this->request, true)))), ['class'=>'btn btn-danger btn-xs','escape'=>false, 'confirm' => __("Confirm delete class ''{0}''", $subject->title)]); ?>
                                    <?php endif;?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
