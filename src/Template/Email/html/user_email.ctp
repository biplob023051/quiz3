...
<p><a href="<?php echo Router::url(array('controller'=>'users', 'action' => 'confirmation', $code),true); ?>"><?php echo Router::url(array('controller'=>'user', 'action' => 'confirmation', $code),true); ?></a></p>
